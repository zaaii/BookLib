               ...
               <div class="navbar-breadcrumb">
                  ...
                  <nav aria-label="breadcrumb">
                     <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Recommendation Page</li>
                     </ul>
                  </nav>
               </div>
                     ...
                     <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                        <div class="iq-card-header d-flex justify-content-between align-items-center position-relative">
                           ...
                           <div class="iq-header-title">
                              <h4 class="card-title mb-0">Result of : "<?= $_GET['keyword'] ?>"</h4>
                           </div>
                           <?php else : ?>
                            <div class="iq-header-title">
                              <h4 class="card-title mb-0">Recommendation</h4>
                           </div>
                            <?php endif; ?>
                        </div>                         
                        <div class="iq-card-body favorites-contens">
                           ...
                           <ul id="favorites-slider" class="list-inline p-0 mb-0 row">
                            <?php $i = 1; foreach ($recommendedBooks as $book) : ?>
                              <li class="col-md-4">
